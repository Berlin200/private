...
client21.login(process.env.KahTOKEN21);
client22.login(process.env.KahTOKEN22);
client23.login(process.env.KahTOKEN23);
client24.login(process.env.KahTOKEN24);
client25.login(process.env.KahTOKEN25);
client26.login(process.env.KahTOKEN26);
client27.login(process.env.KahTOKEN27);
client28.login(process.env.KahTOKEN28);
client29.login(process.env.KahTOKEN29);
client30.login(process.env.KahTOKEN30);
client31.login(process.env.KahTOKEN31);
client32.login(process.env.KahTOKEN32);
client33.login(process.env.KahTOKEN33);
client34.login(process.env.KahTOKEN34);
client35.login(process.env.KahTOKEN35);
client36.login(process.env.KahTOKEN36);
client37.login(process.env.KahTOKEN37);
client38.login(process.env.KahTOKEN38);
client39.login(process.env.KahTOKEN39);
client40.login(process.env.KahTOKEN40);
client41.login(process.env.KahTOKEN41);
client42.login(process.env.KahTOKEN42);
client43.login(process.env.KahTOKEN43);
client44.login(process.env.KahTOKEN44);
client45.login(process.env.KahTOKEN45);
client46.login(process.env.KahTOKEN46);
client47.login(process.env.KahTOKEN47);
client48.login(process.env.KahTOKEN48);
client49.login(process.env.KahTOKEN49);
client50.login(process.env.KahTOKEN50);